            ...
            <div className="relative z-10">
                <div className="container mx-auto px-4 py-20">
                    <div className="grid gap-8 lg:grid-cols-[minmax(0,520px)_minmax(0,1fr)]">
                        <div className="rounded-[32px] border border-slate-200 bg-white/90 p-8 shadow-2xl shadow-slate-200/80 backdrop-blur-md">
                                    ...
                                    <div className="mt-3 flex flex-col gap-3">
                                        {socialLinks.map(({ name, username, url, Icon }) => (
                                            ...
                                            >
                                                ...
                                                <span className="ml-auto text-lg text-slate-300 transition group-hover:text-slate-900">
                                                    ↗
                                                </span>
                                            </a>
                                        ))}
                        ...
                        <div className="relative min-h-[360px] overflow-hidden rounded-[32px] border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-100 shadow-2xl shadow-slate-200/80">
                            <div className="absolute inset-0 bg-gradient-to-b from-white/50 via-transparent to-slate-100/80 pointer-events-none" />
                            <iframe
                            ...
                            />
                            <div className="pointer-events-none absolute inset-4 rounded-[28px] border border-white/40 mix-blend-overlay" />
                        </div>
                    </div>
                </div>
            </div>
